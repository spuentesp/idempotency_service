%% ------------------------------------------------------
%% Module: idempotency
%% Purpose: Extracts key fields and generates an idempotency hash.
%% ------------------------------------------------------
-module(idempotency).
...
%% ------------------------------------------------------
%% @param RuleName - The name of the rule (e.g., "payment", "user_event").
%% @param Data - The event data (as a map).
%% @return A unique hash based on the key fields.
